...
#define PIN_PELTIER_1 GPIO_NUM_32   //Pin where peltier 1 is connected
#define PIN_PELTIER_2 GPIO_NUM_33   //Pin where peltier 2 is connected
#define PIN_PUMP GPIO_NUM_25        //Pin where pump is connected
